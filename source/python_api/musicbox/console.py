...
from PySide@MBOX_PYSIDE_VERSION_MAJOR@.QtGui import QKeySequence
from PySide@MBOX_PYSIDE_VERSION_MAJOR@.QtWidgets import QApplication, QLabel, QLineEdit, QScrollArea, QVBoxLayout, QWidget
