...
from @MBOX_PYSIDE_PACKAGE@.QtGui import QKeySequence
from @MBOX_PYSIDE_PACKAGE@.QtWidgets import QApplication, QLabel, QLineEdit, QScrollArea, QVBoxLayout, QWidget
