...
class Image():
    ...
    def to_vtk(self):
        vtk_type = vtk_type_correspondance[self.np_array.dtype.type]
        vtk_array = numpy_support.numpy_to_vtk(num_array=self.np_array.ravel(), deep=False, array_type=vtk_type)
